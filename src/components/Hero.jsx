...
const Hero = () => {
    return (<>
            <div
                className={`${styles.paddingX} absolute top-[70px] md:top-1/2 md:-translate-y-1/2 inset-0 z-10 max-w-7xl mx-auto flex flex-row  gap-5`}>
                ...
                <div>
                    <h1 className={`${styles.heroHeadText} sm:mb-5 text-white`}>Hi. I'm <span
                        className="text-[#915eff]">Yordan <span>🚀</span></span></h1>
